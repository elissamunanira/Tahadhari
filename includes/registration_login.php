<?php 
	...
	if (isset($_POST['reg_user'])) {
        ...
        if (empty($firstname)) {  array_push($errors, "please enter your firstname"); }
        if (empty($lastname)) {  array_push($errors, "please enter your lastname"); }
		if (empty($username)) {  array_push($errors, "please enter your username"); }
		if (empty($email)) { array_push($errors, "Email is required"); }
		if (empty($password_1)) { array_push($errors, "please enter the password"); }
	...
	function getUserById($id)
	{
		...
		// ['id'=>1 'username' => 'tahadhari', 'email'=>'elissamunanira@gmail.com', 'password'=> 'admin']
		return $user; 
	}
?>